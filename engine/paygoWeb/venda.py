...
class Venda:
    ...
    def venda(self):
        ...
        self.pgWeb.PW_iAddParam(E_PWINFO.PWINFO_AUTHSYST.value, "BIN")  # ADQUIRENTE
        # 1 - CREDITO 2 - DEBITO
        ...
        PWINFO_REQNUM = PWINFO_AUTLOCREF = PWINFO_AUTEXTREF = PWINFO_VIRTMERCH = PWINFO_AUTHSYST = PWINFO_TRNORIGDATE = ''
