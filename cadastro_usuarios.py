...
class CadastroUsuarios:
    def __init__(self, *args):
        ...
        self.window_cadastro_usuario = self.builder.get_object(
            'window_cadastro_usuario'
        )
        self.window_payment = self.builder.get_object('window_wait_payment')
        self.window_entrada_dados = self.builder.get_object(
            'window_entrada_dados'
        )
        self.window_entrada_numeros = self.builder.get_object(
            'window_entrada_numeros'
        )
        self.window_select_cartao = self.builder.get_object(
            'window_select_cartao'
        )
        self.dialog_retorno_cadastro = self.builder.get_object(
            'dialog_retorno_cadastro'
        )
        self.dialog_message_preencher_campos = self.builder.get_object(
            'dialog_message_preencher_campos'
        )
        ...
        self.window_erro_pagamentos = self.builder.get_object(
            'window_erro_pagamento'
        )
        ...
        self.label_quantidade_diaria = self.builder.get_object(
            'label_quantidade_diaria'
        )
        self.label_quantidade_horas = self.builder.get_object(
            'label_quantidade_horas'
        )
        ...
        self.label_valor_da_locacao = self.builder.get_object(
            'label_valor_da_locacao'
        )
        ...
        self.label_compartimento_titulo = self.builder.get_object(
            'label_compartimento_titulo'
        )
        self.label_compartimento = self.builder.get_object(
            'label_compartimento'
        )
        self.label_inicio_locacao_titulo = self.builder.get_object(
            'label_inicio_locacao_titulo'
        )
        self.label_date_inicio_locacao = self.builder.get_object(
            'label_date_inicio_locacao'
        )
        self.label_hour_inicio_locacao = self.builder.get_object(
            'label_hour_inicio_locacao'
        )
        self.label_hour_inicio_locacao1 = self.builder.get_object(
            'label_hour_inicio_locacao1'
        )
        self.label_minute_inicio_locacao = self.builder.get_object(
            'label_minute_inicio_locacao'
        )
        self.label_fim_locacao_titulo = self.builder.get_object(
            'label_fim_locacao_titulo'
        )
        self.label_date_fim_locacao = self.builder.get_object(
            'label_date_fim_locacao'
        )
        self.label_hour_fim_locacao = self.builder.get_object(
            'label_hour_fim_locacao'
        )
        self.label_hour_fim_locacao1 = self.builder.get_object(
            'label_hour_fim_locacao1'
        )
        self.label_minute_fim_locacao = self.builder.get_object(
            'label_minute_fim_locacao'
        )
        self.label_message_envio_email = self.builder.get_object(
            'label_message_envio_email'
        )
        ...
        self.label_entrada_numeros = self.builder.get_object(
            'label_entrada_numeros'
        )
        ' ----------   LABEL DIALOGO RETORNO CADASTRO ---'
        self.label_retorno_cadastro = self.builder.get_object(
            'label_retorno_cadastro'
        )
        ' ----------   LABEL dialog_message_preencher_campos -------------'
        self.label_message_preencher_campos = self.builder.get_object(
            'label_message_preencher_campos'
        )
        ...
        self.label_window_erro_pagamentos = self.builder.get_object(
            'label_window_erro_pagamentos'
        )
        ...
        self.entry_nome.connect(
            'button_press_event', self.on_entry_nome_button_press_event
        )
        self.entry_email = self.builder.get_object('entry_email')
        self.entry_email.connect(
            'button_press_event', self.on_entry_email_button_press_event
        )
        self.entry_celular = self.builder.get_object('entry_celular')
        self.entry_celular.connect(
            'button_press_event', self.on_entry_celular_button_press_event
        )
        self.entry_quantidade_diaria = self.builder.get_object(
            'entry_quantidade_diaria'
        )
        self.entry_quantidade_diaria.connect(
            'button_press_event',
            self.on_entry_quantidade_diaria_button_press_event,
        )
        self.entry_quantidade_horas = self.builder.get_object(
            'entry_quantidade_horas'
        )
        self.entry_quantidade_horas.connect(
            'button_press_event',
            self.on_entry_quantidade_horas_button_press_event,
        )
        ...
        self.entry_entrada_dados = self.builder.get_object(
            'entry_entrada_dados'
        )
        self.entry_entrada_dados.connect(
            'button_press_event',
            self.on_entry_entrada_dados_button_press_event,
        )
        """ -----------ENTRY WINDOW_ENTRADA_NUMEROS ---------"""
        self.entry_entrada_numeros = self.builder.get_object(
            'entry_entrada_numeros'
        )
        ...
        self.btn_limpar_nome.connect(
            'button_press_event', self.on_btn_limpar_nome_button_press_event
        )
        self.btn_limpar_email = self.builder.get_object('btn_limpar_email')
        self.btn_limpar_email.connect(
            'button_press_event', self.on_btn_limpar_email_button_press_event
        )
        self.btn_limpar_celular = self.builder.get_object('btn_limpar_celular')
        self.btn_limpar_celular.connect(
            'button_press_event', self.on_btn_limpar_celular_button_press_event
        )
        self.btn_limpar_quantidade_diaria = self.builder.get_object(
            'btn_limpar_quantidade_diaria'
        )
        self.btn_limpar_quantidade_diaria.connect(
            'button_press_event',
            self.on_btn_limpar_quantidade_diaria_button_press_event,
        )
        self.btn_limpar_horas = self.builder.get_object('btn_limpar_horas')
        self.btn_limpar_horas.connect(
            'button_press_event', self.on_btn_limpar_horas_button_press_event
        )
        ...
        self.btn_confirmar = self.builder.get_object(
            'btn_confirmar_cadastro_usuario'
        )
        self.btn_confirmar.connect(
            'button_press_event', self.on_btn_confirmar_button_press_event
        )
        self.btn_retornar = self.builder.get_object('btn_retornar')
        self.btn_retornar.connect(
            'button_press_event', self.on_btn_retornar_button_press_event
        )
        self.btn_limpar_entrada_numeros = self.builder.get_object(
            'btn_limpar_entrada_numeros'
        )
        self.btn_limpar_entrada_numeros.connect(
            'button_press_event',
            self.on_btn_limpar_entrada_numeros_button_press_event,
        )
        ...
        self.btn_confirmar_entrada_dados.connect(
            'button_press_event',
            self.on_btn_confirmar_entrada_dados_button_press_event,
        )
        ...
        self.btn_retornar_entrada_dados.connect(
            'button_press_event',
            self.on_btn_retornar_entrada_dados_button_press_event,
        )
        self.btn_backspace = self.builder.get_object('btn_backspace')
        self.btn_backspace.connect(
            'button_press_event', self.on_btn_backspace_button_press_event
        )
        ...
        self.btn_um.connect(
            'clicked', self.on_entry_entrada_numeros_button_press_event
        )
        self.btn_dois = self.builder.get_object('btn_dois')
        self.btn_dois.connect(
            'clicked', self.on_entry_entrada_numeros_button_press_event
        )
        self.btn_tres = self.builder.get_object('btn_tres')
        self.btn_tres.connect(
            'clicked', self.on_entry_entrada_numeros_button_press_event
        )
        self.btn_quatro = self.builder.get_object('btn_quatro')
        self.btn_quatro.connect(
            'clicked', self.on_entry_entrada_numeros_button_press_event
        )
        self.btn_cinco = self.builder.get_object('btn_cinco')
        self.btn_cinco.connect(
            'clicked', self.on_entry_entrada_numeros_button_press_event
        )
        self.btn_seis = self.builder.get_object('btn_seis')
        self.btn_seis.connect(
            'clicked', self.on_entry_entrada_numeros_button_press_event
        )
        self.btn_sete = self.builder.get_object('btn_sete')
        self.btn_sete.connect(
            'clicked', self.on_entry_entrada_numeros_button_press_event
        )
        self.btn_oito = self.builder.get_object('btn_oito')
        self.btn_oito.connect(
            'clicked', self.on_entry_entrada_numeros_button_press_event
        )
        self.btn_nove = self.builder.get_object('btn_nove')
        self.btn_nove.connect(
            'clicked', self.on_entry_entrada_numeros_button_press_event
        )
        self.btn_zero = self.builder.get_object('btn_zero')
        self.btn_zero.connect(
            'clicked', self.on_entry_entrada_numeros_button_press_event
        )
        self.btn_confirmar_entrada_numero = self.builder.get_object(
            'btn_confirmar_entrada_numero'
        )
        self.btn_confirmar_entrada_numero.connect(
            'button_press_event',
            self.on_btn_confirmar_entrada_numero_button_press_event,
        )
        self.btn_retornar_entrada_numeros = self.builder.get_object(
            'btn_retornar_entrada_numeros'
        )
        self.btn_retornar_entrada_numeros.connect(
            'button_press_event',
            self.on_btn_retornar_entrada_numeros_button_press_event,
        )

        # =================== BOTÕES DIALOGOS ====================
        self.btn_ok_dialog_retorno_cadastro = self.builder.get_object(
            'btn_ok_dialog_retorno_cadastro'
        )
        self.btn_ok_dialog_retorno_cadastro.connect(
            'button_press_event',
            self.on_btn_ok_dialog_retorno_cadastro_pressed,
        )
        self.btn_dialog_preencher_campos = self.builder.get_object(
            'btn_dialog_preencher_campos'
        )
        self.btn_dialog_preencher_campos.connect(
            'button_press_event',
            self.on_btn_dialog_preencher_campos_pressed_event,
        )
        self.btn_finalizar_sessao = self.builder.get_object(
            'btn_finalizar_sessao'
        )
        self.btn_finalizar_sessao.connect(
            'button_press_event',
            self.on_btn_finalizar_sessao_button_press_event,
        )
        ...
        self.button_fechar_armario.connect(
            'button_press_event',
            self.on_button_fechar_armario_button_press_event,
        )
        ...
        self.btn_debito.connect(
            'button-press-event', self.on_btn_debito_button_press_event
        )
        self.btn_cancelar_escolha = self.builder.get_object(
            'btn_cancelar_escolha'
        )
        self.btn_cancelar_escolha.connect(
            'button-press-event', self.on_btn_cancelar_button_press_event
        )

        # ======================== BOTOES window_erro_pagamentos =================
        self.btn_tente_novamente_window_erro_pagamentos = (
            self.builder.get_object(
                'btn_tente_novamente_window_erro_pagamentos'
            )
        )
        ...
        self.btn_cancelar_window_erro_pagamentos = self.builder.get_object(
            'btn_cancelar_window_erro_pagamentos'
        )
        ...
        for alfabet in self.alfa:
            ...
            self.alfabet.connect(
                'clicked', self.on_entry_entrada_dados_button_press_event
            )
        for num in self.num:
        ...
        FLAG_BR = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/brasil.png', 32, 50
        )
        FLAG_AFRICA_SUL = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/africa_sul.png', 32, 50
        )
        FLAG_ALE = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/alemanha.png', 32, 50
        )
        FLAG_ARABIA = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/arabia_saudita.png', 32, 50
        )
        FLAG_ARGEL = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/argelia.png', 32, 50
        )
        FLAG_ARGENTINA = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/argentina.png', 32, 50
        )
        FLAG_AUSTRALIA = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/australia.png', 32, 50
        )
        FLAG_AUSTRIA = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/austria.png', 32, 50
        )
        FLAG_BAREIN = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/barein.png', 32, 50
        )
        FLAG_BELGICA = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/belgica.png', 32, 50
        )
        FLAG_BOLIVIA = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/bolivia.png', 32, 50
        )
        FLAG_CANADA = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/canada.png', 32, 50
        )
        FLAG_CHILE = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/chile.png', 32, 50
        )
        FLAG_CHINA = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/china.png', 32, 50
        )
        FLAG_COLOMBIA = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/colombia.png', 32, 50
        )
        FLAG_COREIA_SUL = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/coreia_sul.png', 32, 50
        )
        FLAG_COSTA_RICA = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/costa_rica.png', 32, 50
        )
        FLAG_DINAMARCA = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/dinamarca.png', 32, 50
        )
        FLAG_EMIRADOS = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/emirados_arabes.png', 32, 50
        )
        FLAG_EQUADOR = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/equador.png', 32, 50
        )
        FLAG_ESPANHA = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/espanha.png', 32, 50
        )
        FLAG_USA = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/estados_unidos.png', 32, 50
        )
        FLAG_FINLANDIA = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/finlandia.png', 32, 50
        )
        FLAG_FRANCA = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/franca.png', 32, 50
        )
        FLAG_HONG_KONG = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/hong_kong.png', 32, 50
        )
        FLAG_IRAN = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/iran.png', 32, 50
        )
        FLAG_IRAQUE = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/iraque.png', 32, 50
        )
        FLAG_IRLANDA = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/irlanda.png', 32, 50
        )
        FLAG_ISLANDIA = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/islandia.png', 32, 50
        )
        FLAG_ISRAEL = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/israel.png', 32, 50
        )
        FLAG_ITALIA = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/italia.png', 32, 50
        )
        FLAG_JAPAO = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/japao.png', 32, 50
        )
        FLAG_MEXICO = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/mexico.png', 32, 50
        )
        FLAG_NORUEGA = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/noruega.png', 32, 50
        )
        FLAG_PARAGUAI = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/paraguai.png', 32, 50
        )
        FLAG_PORTUGAL = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/portugal.png', 32, 50
        )
        FLAG_REINO_UNIDO = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/reino_unido.png', 32, 50
        )
        FLAG_RUSSIA = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/russia.png', 32, 50
        )
        FLAG_SINGAPURA = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/singapura.png', 32, 50
        )
        FLAG_SUICA = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/suica.png', 32, 50
        )
        FLAG_SUECIA = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/suecia.png', 32, 50
        )
        FLAG_URUGUAI = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/uruguai.png', 32, 50
        )
        FLAG_VENEZUELA = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/venezuela.png', 32, 50
        )
        FLAG_AFEGAN = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/afeganistao.png', 32, 50
        )
        FLAG_QUENIA = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/quenia.png', 32, 50
        )
        FLAG_MONACO = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/monaco.png', 32, 50
        )
        FLAG_POLONIA = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/polonia.png', 32, 50
        )
        FLAG_GRECIA = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/grecia.png', 32, 50
        )
        FLAG_BULGARIA = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/bulgaria.png', 32, 50
        )
        FLAG_HOLANDA = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/holanda.png', 32, 50
        )
        FLAG_ROMENIA = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/romenia.png', 32, 50
        )
        FLAG_CROACIA = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/croacia.png', 32, 50
        )
        FLAG_ESLOVENIA = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/eslovenia.png', 32, 50
        )
        FLAG_ESLOVAQUIA = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/eslovaquia.png', 32, 50
        )
        FLAG_SERVIA = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/servia.png', 32, 50
        )
        NO_FLAG = GdkPixbuf.Pixbuf.new_from_file_at_size(
            'static/images/flags_ddd/no_flag.png', 32, 50
        )
        ...
        self.combobox_flags_ddd.add_attribute(
            self.cell_renderer_text, 'text', 1
        )
        ...
        if self.language == 'pt_BR':
            ...
            self.label_quantidade_diaria.set_text(
                'QUANTIDADE DIÁRIA'
            )   # daily amount
            self.label_quantidade_horas.set_text(
                'QUANTIDADE HORAS'
            )   # quantity of hours
            ...
            self.label_message_envio_email.set_text(
                'UM EMAIL COM O RECAPTULATIVO DE SUA\n RESERVA ACABA DE LHE SER ENVIADO!'
            )
            self.button_fechar_armario.set_label('FECHAR ARMÁRIO')
            self.btn_tente_novamente_window_erro_pagamentos.set_label(
                'TENTE NOVAMENTE'
            )
            ...
            self.label_instrucao.set_text(
                'Obigado por utilizar nossos serviços! Lhe desejamos um dia incrível!'
            )
            ...
            self.label_message_envio_email.set_text(
                'AN EMAIL WITH THE RECAPTULATIVE OF YOUR\n RESERVATION HAS JUST BEEN SENT!'
            )
            ...
            self.label_instrucao.set_text(
                'Thanks for using our services. We desired an awesome day!'
            )
    ...
    def send_tipo_cartao(self, tipo):
        ...
        self.__quantidade_diaria = (
            self.dia
        )   # self.entry_quantidade_diaria.get_text()
        ...
        if self.__nome == '':
            if self.language == 'pt_BR':
                self.label_message_preencher_campos.set_text(
            ...
            print(
                'locacao',
                self.__quantidade_diaria,
                self.__quantidade_horas,
                self.__quantidade_minutos,
            )
            manager = Management()
            self.__result = manager.locacao(
                self.__nome,
                self.__email,
                self.__telefone,
                self.__quantidade_diaria,
            ...
            if self.__result[0]['message'] == 'locacao concluida com sucesso':
                ...
                self.label_hour_inicio_locacao.set_text(
                    hora_inicio_locacao[:2]
                )
                self.label_hour_inicio_locacao1.set_text(
                    hora_inicio_locacao[3:]
                )
                ...
                self.__result[0]['message']
                == 'armario da classe escolhida indisponível'
            ):
                if self.language == 'pt_BR':
                    self.label_retorno_cadastro.set_text(
                ...
                # self.window_payment.hide()
                self.label_window_erro_pagamentos.set_text(
                    self.__result[0]['message']
                )
    ...
    def on_btn_tente_novamente_window_erro_pagamentos_button_press_event(
        self, widget, event
    ):
    ...
    def on_btn_cancelar_window_erro_pagamentos_button_press_event(
        self, widget, event
    ):
        self.window_erro_pagamentos.hide()
        # self.window_payment.hide()
    ...
    def on_btn_limpar_quantidade_diaria_button_press_event(
        self, widget, event
    ):
    ...
    def on_btn_confirmar_entrada_dados_button_press_event(self, widget, event):
        ...
        if (
            self.label_entrada_dados.get_text() == 'NOME'
            or self.label_entrada_dados.get_text() == 'NAME'
        ):
    ...
    def on_btn_confirmar_entrada_numero_button_press_event(
        self, widget, event
    ):
        if (
            self.label_entrada_numeros.get_text() == 'CELULAR'
            or self.label_entrada_numeros.get_text() == 'PHONE '
        ):
            self.ddd = self.combobox_flags_ddd.get_active()

            print('self ddd', self.ddd)
            self.entry_celular.set_text(
                str(DDD[self.ddd]) + ' ' + str(self.text_entrada)
            )
            self.entry_celular.set_position(-1)
            self.window_entrada_numeros.hide()

    def on_btn_retornar_entrada_numeros_button_press_event(
        self, widget, event
    ):
        self.window_entrada_numeros.hide()
