...
class CadastroUsuarios:
    ...
    """def on_btn_window_payment_wait_button_press_event(self, widget, event):
        ...
        if self.__nome == "":
            ...
            self.__armario = self.classe
            print("locacao", self.__quantidade_diaria,
            self.__quantidade_horas, self.__quantidade_minutos)
            manager = Management()
            self.__result =  manager.locacao(self.__nome,
            self.__email, self.__telefone,
            self.__quantidade_diaria,
            self.__quantidade_horas,
            self.__quantidade_minutos,
            self.__armario, self.language, self.valor_total)
            count = 0
            #self.__result = self.__result[0]
    ...
    """def wait_payment(self, tipo):
        ...
        if self.__nome == "":
            ...
            self.__armario = self.classe
            print("locacao", self.__quantidade_diaria,
            elf.__quantidade_horas, self.__quantidade_minutos)
            manager = Management()
            self.__result =  manager.locacao(self.__nome,
            self.__email, self.__telefone,
            self.__quantidade_diaria,
