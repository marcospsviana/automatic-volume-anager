...
class SelectHora(object):
    ...
    def __init__(self, *args):
        ...
        self.builder = Gtk.Builder()
        self.builder.add_from_file("ui/selec_hora_window.glade")
        self.builder.connect_signals({
            "gtk_main_quit": Gtk.main_quit,
        ...
        self.select_hora_window = self.builder.get_object("select_hora_window")
        ...
        self.label_hora_ecolhida_down = self.builder.get_object("label_hora_ecolhida_down")
